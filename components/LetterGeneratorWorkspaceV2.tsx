...
export default function LetterGeneratorWorkspaceV2() {
  ...
  const showStatus = statusTone !== 'info';
  const showPreflight = panel === 'Source Data' && statusTone === 'error' && Boolean(source.trim()) && (!preflight.ready || preflight.warnings.length > 0);
