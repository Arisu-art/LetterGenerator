...
function EditablePacketSection({ slot, onSave }: { slot: Slot; onSave: Props['onSave'] }) {
  ...
  useEffect(() => {
    let alive = true;
    setDirty(false); setStatus('Loading document'); setActiveId(''); paragraphNodes.current.clear();
